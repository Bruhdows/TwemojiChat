...
minecraft {
    ...
    runs {
        register("client") {
            workingDir.set(layout.projectDirectory.dir("run/forge/1_20_4"))
...
dependencies {
    add("implementation", minecraft.dependency("net.minecraftforge:forge:1.20.4-49.2.7"))
}
    ...
    filesMatching("META-INF/mods.toml") {
        expand(
            mapOf(
                ...
                "neo_version" to "1.20.4-49.2.7",
                "neo_version_range" to "[49.2,)",
