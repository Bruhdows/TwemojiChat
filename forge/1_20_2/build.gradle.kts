...
minecraft {
    ...
    runs {
        register("client") {
            workingDir.set(layout.projectDirectory.dir("run/forge/1_20_2"))
...
dependencies {
    add("implementation", minecraft.dependency("net.minecraftforge:forge:1.20.2-48.1.0"))
}
    ...
    filesMatching("META-INF/mods.toml") {
        expand(
            mapOf(
                ...
                "neo_version" to "1.20.2-48.1.0",
                "neo_version_range" to "[48.1,)",
                "loader_version_range" to "[48,)",
