...
extensions.configure<NeoForgeExtension> {
    ...
    runs {
        create("client") {
            client()
            gameDirectory.set(project.layout.projectDirectory.dir("run/neoforge/1_21_10"))
        }
    ...
    filesMatching("META-INF/neoforge.mods.toml") {
        expand(
            mapOf(
                ...
                "minecraft_version_range" to "[1.21.10,1.22)",
                "neo_version" to "21.10.64",
                "neo_version_range" to "[21.10,)",
