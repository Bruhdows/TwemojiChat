...
extensions.configure<NeoForgeExtension> {
    setVersion("21.7.25-beta")

    runs {
        create("client") {
            client()
            gameDirectory.set(project.layout.projectDirectory.dir("run/neoforge/1_21_7"))
        }
    ...
    filesMatching("META-INF/neoforge.mods.toml") {
        expand(
            mapOf(
                ...
                "minecraft_version_range" to "[1.21.7,1.22)",
                "neo_version" to "21.7.25-beta",
                "neo_version_range" to "[21.7,)",
