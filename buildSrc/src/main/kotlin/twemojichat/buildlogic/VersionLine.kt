...
data class VersionLine(
    ...
    val forgeVersionRange: String? = null,
    val forgeLoaderVersionRange: String? = null,
...
val SUPPORTED_VERSION_LINES = listOf(
    VersionLine(
        ...
        forgeVersionRange = "[47.4,)",
        forgeLoaderVersionRange = "[47,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.20.2-48.1.0",
        forgeVersionRange = "[48.1,)",
        forgeLoaderVersionRange = "[48,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.20.3-49.0.2",
        forgeVersionRange = "[49.0,)",
        forgeLoaderVersionRange = "[49,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.20.4-49.2.7",
        forgeVersionRange = "[49.2,)",
        forgeLoaderVersionRange = "[49,)",
    ...
    VersionLine(
        projectName = "1_20_6",
        sourceSetDirectory = "1205",
        loaders = setOf(LoaderKind.FABRIC, LoaderKind.FORGE, LoaderKind.NEOFORGE),
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.20.6-50.2.8",
        forgeVersionRange = "[50.2,)",
        forgeLoaderVersionRange = "[50,)",
        neoVersion = "20.6.139",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21-51.0.3",
        forgeVersionRange = "[51.0,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.1-52.1.14",
        forgeVersionRange = "[52.1,)",
        forgeLoaderVersionRange = "[52,)",
        neoVersion = "21.1.233",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.3-53.1.10",
        forgeVersionRange = "[53.1,)",
        forgeLoaderVersionRange = "[53,)",
        neoVersion = "21.3.96",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.4-54.1.16",
        forgeVersionRange = "[54.1,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.5-55.1.10",
        forgeVersionRange = "[55.1,)",
        forgeLoaderVersionRange = "[55,)",
        neoVersion = "21.5.97",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.6-56.0.2",
        forgeVersionRange = "[56.0,)",
        forgeLoaderVersionRange = "[56,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.7-57.0.2",
        forgeVersionRange = "[57.0,)",
        forgeLoaderVersionRange = "[57,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.8-58.1.18",
        forgeVersionRange = "[58.1,)",
        forgeLoaderVersionRange = "[58,)",
        neoVersion = "21.8.53",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.9-59.0.5",
        forgeVersionRange = "[59.0,)",
        forgeLoaderVersionRange = "[59,)",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.10-60.1.9",
        forgeVersionRange = "[60.1,)",
        forgeLoaderVersionRange = "[60,)",
        neoVersion = "21.10.64",
    ...
    VersionLine(
        ...
        fabricPluginId = "net.fabricmc.fabric-loom-remap",
        forgeVersion = "1.21.11-61.1.8",
        forgeVersionRange = "[61.1,)",
        forgeLoaderVersionRange = "[61,)",
        neoVersion = "21.11.42",
    ...
    VersionLine(
        ...
        forgeVersion = "26.1.2-64.0.8",
        forgeVersionRange = "[64.0,)",
        forgeLoaderVersionRange = "[64,)",
